...
class LeaveRequestService
{
    ...
    /**
     * Force cancel leave request without workflow guard checks.
     */
    public function forceCancelLeaveRequest(DetailedLeaveRequest $leaveRequest): void
    {
        $this->_changeLeaveStatus($leaveRequest->getLeaves(), Leave::LEAVE_STATUS_LEAVE_CANCELLED);
    }

    /**
     * Hard delete a leave request and all its related records.
     */
    public function hardDeleteLeaveRequest(LeaveRequest $leaveRequest): void
    {
        $this->getLeaveRequestDao()->hardDeleteLeaveRequestsByIds([$leaveRequest->getId()]);
    }
