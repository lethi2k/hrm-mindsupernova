...
class TimeConfigPeriodAPI extends Endpoint implements ResourceEndpoint
{
    ...
    public function getOne(): EndpointResult
    {
        ...
        $startDay = $status ? $this->getTimesheetPeriodService()->getTimesheetStartDate() : '1';
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="startDay", type="integer", minimum=1, maximum=31),
     *             required={"startDay"}
     *         )
     *     ),
