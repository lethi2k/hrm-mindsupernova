...
class EmployeeTimesheetListSearchFilterParams extends FilterParams
{
    ...
    private ?bool $hasLoggedTime = null;
    ...
    public function hasLoggedTime(): ?bool
    {
        return $this->hasLoggedTime;
    }

    public function setHasLoggedTime(?bool $hasLoggedTime): void
    {
        $this->hasLoggedTime = $hasLoggedTime;
    }
}
