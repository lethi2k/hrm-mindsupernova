    ...
    >
      ...
      <template #footer-title>
        ...
        <oxd-text
          ...
          type="subtitle-2"
        >
          {{ standardWorkingDaysLabel }}: {{ standardWorkDays }}
        </oxd-text>
        <oxd-text
          v-show="timesheet?.startDate && timesheet?.endDate"
          type="subtitle-2"
...
export default {
  ...
  computed: {
    ...
    standardWorkDays() {
      const startDate = parseDate(this.timesheet?.startDate || '');
      const endDate = parseDate(this.timesheet?.endDate || '');
    ...
    standardWorkHours() {
      return this.standardWorkDays * 8;
    },
    standardWorkHoursLabel() {
      return `${this.standardWorkHours}:00`;
    },
  },
};
</script>
